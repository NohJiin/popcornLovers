...
<body>
	...
	<div class="all">
		...
		<div class="calendarsetting">
			...
			<form name="frm" method="get" action="mycalendardelete.jsp">

				<button type="button"
					onclick="location='mycalendardelete.jsp?yy=<%=b_y%>&mm=<%=b_m%>'">이전</button>
				...
				<button type="button"
					onclick="location='mycalendardelete.jsp?yy=<%=n_y%>&mm=<%=n_m%>'">다음</button>

			</form>
		</div>
		<div class="calendarinsert">
		
			<form action="mycalendardelete" method="post">
			<table class="inserttable">
			<caption  class="insertcaption">일정 삭제 하기</caption>
			<tr>
			...
			<tr><td colspan="2" class="insert2"><button type="submit" id="deletebutton">삭제하기</button></td></tr>
			</table>
			</form>
		</div>
	</div>
