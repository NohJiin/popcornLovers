...
<body>
	...
	<div class="all">
		...
		<div class="calendarsetting">
			...
			<form name="frm" method="get" action="mycalendarmain.jsp">

				<button type="button"
					onclick="location='mycalendarmain.jsp?yy=<%=b_y%>&mm=<%=b_m%>'">이전</button>
				...
				<button type="button"
					onclick="location='mycalendarmain.jsp?yy=<%=n_y%>&mm=<%=n_m%>'">다음</button>
