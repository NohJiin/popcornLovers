...
<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=04b500e325879415373f7b3fa5ff0e86&redirect_uri=http://localhost:8887/popcornLovers_war_exploded/stepThree">
...
라인ID는 알림을 위해 사용되며 카카오ID는 개인 식별을 위해 사용됩니다.<br><br>
    <img src="${pageContext.request.contextPath}/resources/l">
</div>
