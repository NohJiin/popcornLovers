...
<link rel="stylesheet" href="../resources/css/bbscss2.css?d">
</head>
<body>
	...
	<div class="board_wrap">
		...
		<div class="board_view_wrap">
						...
						<div class="mt-3">
							<ul>
								<c:forEach var="file" items="${list2[0].fileInfos}">
        							<img src="${file.save_folder}/${file.save_file}" alt="${file.original_file}">
								</c:forEach>
							</ul>
						</div>
					</c:if>
			...
			<div class="comment_headline">
				...
				<p>좋아요</p>
				<span id="likes_sum">${list2[0].bbs_like}</span><img
                    ...
                    <div class="comment_list_info">
                        ...
                        <div class="comment_list_first_line">
                            ...
                            <div class="comment_list_first_line_item2">
                                ...
                                <button class="reply_btn" value="${one.b_comment_id}">답글쓰기</button>
                            </div>
                        </div>
                    </div>
