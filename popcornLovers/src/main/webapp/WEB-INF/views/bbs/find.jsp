	...
	<div id="paging_result">
		<div class="board_wrap">
			...
			<div class="board_list_cnt">
				<p>
					전체 : <span class="board_list_cnt_highlight">${count2}</span>개
				</p>
				<div>
					<div class="board_list_wrap">
						<div class="board_list">
							...
							<c:forEach items="${list2}" var="one">
								<div class="bottom">
									...
									<div class="title">
										<a
											href="detail_post?bbs_no=${one.bbs_no}&bbs_cate_num=${one.bbs_cate_num}">${one.bbs_title}</a>
									</div>
						...
						<div class="bt_wrap" style="height: 60px;">
							<a href="${root}/bbs/write/${info2[0].bbs_cate_num}" class="on"
								style="background-color: orange; border: none; float: right;">글쓰기</a>
						</div>
