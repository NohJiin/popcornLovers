	 ...
	 <div class="main_content">
            ...
            <div class="top_post">
				<div class="posts_contents">
					...
					<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/first.png" style="width: 40px; height: 40px;"><span><a href="bbs/detail_post?bbs_no=${likes[0].bbs_no}&bbs_cate_num=${likes[0].bbs_cate_num}">${likes[0].bbs_title}</a></span></div>
					<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/second.png" style="width: 40px; height: 40px;"><span style="text-align: left;display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis"><a href="bbs/detail_post?bbs_no=${likes[1].bbs_no}&bbs_cate_num=${likes[1].bbs_cate_num}">${likes[1].bbs_title}</a></span></div>
					<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/third.png" style="width: 40px; height: 40px;"><span><a href="bbs/detail_post?bbs_no=${likes[2].bbs_no}&bbs_cate_num=${likes[2].bbs_cate_num}">${likes[2].bbs_title}</a></span></div>
					<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/forth.png" style="width: 40px; height: 40px;"><span><a href="bbs/detail_post?bbs_no=${likes[3].bbs_no}&bbs_cate_num=${likes[3].bbs_cate_num}">${likes[3].bbs_title}</a></span></div>
					<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/fifth.png" style="width: 40px; height: 40px;"><span><a href="bbs/detail_post?bbs_no=${likes[4].bbs_no}&bbs_cate_num=${likes[4].bbs_cate_num}">${likes[4].bbs_title}</a></span></div>
					</div>
					</div>
				</div>
            </div>
            <div class="top_review_post">
				<div class="posts_contents">
					<div class="posts_sub_contents">
						...
						<hr style="margin-top: 10px; margin-bottom: 15px; width: 93%;">
						<div class="posts_sub_contents_box" style="padding-left: 10px; margin-right: 19px;">
						<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/first.png" style="width: 40px; height: 40px;"><span><a href="bbs/detail_post?bbs_no=${hits[0].bbs_no}&bbs_cate_num=${hits[0].bbs_cate_num}">${hits[0].bbs_title}</a></span></div>
						<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/second.png" style="width: 40px; height: 40px;"><span style="text-align: left;display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis"><a href="bbs/detail_post?bbs_no=${hits[1].bbs_no}&bbs_cate_num=${hits[1].bbs_cate_num}">${hits[1].bbs_title}</a></span></div>
						<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/third.png" style="width: 40px; height: 40px;"><span><a href="bbs/detail_post?bbs_no=${hits[2].bbs_no}&bbs_cate_num=${hits[2].bbs_cate_num}">${hits[2].bbs_title}</a></span></div>
						<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/forth.png" style="width: 40px; height: 40px;"><span><a href="bbs/detail_post?bbs_no=${hits[3].bbs_no}&bbs_cate_num=${hits[3].bbs_cate_num}">${hits[3].bbs_title}</a></span></div>
						<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/fifth.png" style="width: 40px; height: 40px;"><span><a href="bbs/detail_post?bbs_no=${hits[4].bbs_no}&bbs_cate_num=${hits[4].bbs_cate_num}">${hits[4].bbs_title}</a></span></div>
						</div>
						</div>
                </div>
            </div>
            ...
            <div class="latest_post">
				<div class="posts_contents">
					<div class="posts_sub_contents">
						<div class="top_post_first_line"><span style="text-align: left;">최신 게시글</span><span class="top_post_plus" style="text-align: right;"><a href="bbs/post">+</a></span></div>
							<hr style="margin-top: 10px; margin-bottom: 16px; width: 93%;">
							<div class="posts_sub_contents_box" style="padding-left: 10px; margin-right: 19px;">
							<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/new.png" style="width: 40px; height: 40px;"><span><a href="bbs/detail_post?bbs_no=${newest_bbs[0].bbs_no}&bbs_cate_num=${newest_bbs[0].bbs_cate_num}">${newest_bbs[0].bbs_title}</a></span></div>
							<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/new.png" style="width: 40px; height: 40px;"><span style="text-align: left; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis;"><a href="bbs/detail_post?bbs_no=${newest_bbs[1].bbs_no}&bbs_cate_num=${newest_bbs[1].bbs_cate_num}">${newest_bbs[1].bbs_title}</a></span></div>
							<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/new.png" style="width: 40px; height: 40px;"><span><a href="bbs/detail_post?bbs_no=${newest_bbs[2].bbs_no}&bbs_cate_num=${newest_bbs[2].bbs_cate_num}">${newest_bbs[2].bbs_title}</a></span></div>
							<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/new.png" style="width: 40px; height: 40px;"><span><a href="bbs/detail_post?bbs_no=${newest_bbs[3].bbs_no}&bbs_cate_num=${newest_bbs[3].bbs_cate_num}">${newest_bbs[3].bbs_title}</a></span></div>
							<div style="display: flex; align-items: center;"><img src="./resources/img/bbs/new.png" style="width: 40px; height: 40px;"><span><a href="bbs/detail_post?bbs_no=${newest_bbs[4].bbs_no}&bbs_cate_num=${newest_bbs[4].bbs_cate_num}">${newest_bbs[4].bbs_title}</a></span></div>
							</div>
							</div>
                </div>
            </div>
			...
			<div class="news_list">
                <div class="news_contents">
					...
					<a class="news_contents_more" href ="bbs/getNewsAllList">+ 더보기</a>
					</div>
